  ...
  return (
    <div className="min-h-screen bg-[#050b14] text-white">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="hidden sm:flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/[0.04] border border-white/10 hover:bg-white/[0.08] transition text-sm font-semibold"
              >
                👤 Profile
              </button>
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-red-500/10 border border-red-500/20 text-red-300 hover:bg-red-500/20 transition text-sm font-semibold"
              >
                Logout
              </button>
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-5 py-8">
        ...
        <section className="relative overflow-hidden rounded-[28px] border border-white/10 bg-gradient-to-br from-blue-500/[0.10] via-white/[0.03] to-purple-500/[0.06] p-7 md:p-9">
          ...
          <div className="relative flex flex-col md:flex-row md:items-center gap-6">
            ...
            {technician.profilePhoto ? (
              <img
                ...
                className="w-24 h-24 rounded-3xl object-cover border border-white/10 shadow-xl"
              />
            ) : (
              <div className="w-24 h-24 shrink-0 rounded-3xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-4xl">
                🔧
              </div>
            )}
        ...
        <section className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
          ...
          <div className="group rounded-2xl border border-white/10 bg-white/[0.03] p-5 hover:bg-white/[0.05] transition">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="w-9 h-9 rounded-xl bg-blue-500/10 flex items-center justify-center">
                📋
              </span>
          ...
          <div className="group rounded-2xl border border-white/10 bg-white/[0.03] p-5 hover:bg-white/[0.05] transition">
            ...
            <p className="text-3xl font-black mt-4 text-amber-300">
          ...
          <div className="group rounded-2xl border border-white/10 bg-white/[0.03] p-5 hover:bg-white/[0.05] transition">
            ...
            <p className="text-3xl font-black mt-4 text-purple-300">
              {requestStats.active}
            </p>
          ...
          <div className="group rounded-2xl border border-white/10 bg-white/[0.03] p-5 hover:bg-white/[0.05] transition">
            ...
            <p className="text-3xl font-black mt-4 text-emerald-300">
        ...
        {requestError && (
          <div className="mt-6 flex items-start gap-3 p-4 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-300">
                    ...
                    <div className="p-6 md:p-7">
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-5">
                        ...
                        <div className="flex gap-4">
                          ...
                          <div className="w-14 h-14 shrink-0 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-2xl">
                            {request.serviceType ===
                            "electrician"
                              ? "⚡"
                              : request.serviceType ===
      ...
      {showAcceptModal && selectedRequest && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg rounded-[28px] border border-white/10 bg-[#0b1422] shadow-2xl shadow-black/50 overflow-hidden">
            ...
            <div className="p-6 md:p-7 border-b border-white/10">
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <button
                  ...
                  className="w-9 h-9 rounded-xl bg-white/5 hover:bg-white/10 text-slate-400 hover:text-white transition disabled:opacity-50"
                >
                  ✕
                </button>
            ...
            <div className="p-6 md:p-7 pt-0 flex flex-col sm:flex-row gap-3">
